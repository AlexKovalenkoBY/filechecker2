((D, B, log = (arg) => console.log(arg)) => {
    ...
    startButton.addEventListener('click', (button) => {
        ...
        if ((bp.name !== 'DataTreeBP.CSV') ||
            ...
            // div.className = "rot"
            // div.innerHTML = "<img src='./grinning-face-smile-emoji-happy-37705.webp' />"
            B.appendChild(D.createElement('div')).appendChild(D.createElement('img')).innerHTML = "<img src='./grinning-face-smile-emoji-happy-37705.webp' />";
